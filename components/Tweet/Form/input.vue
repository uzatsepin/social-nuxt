<template>
    <div>
        ...
        <!-- file selector -->
        <div class="p-4 pl-16">
            <img :src="inputImageUrl" v-if="inputImageUrl" alt="" class="rounded-2xl border" :class="twitterBorderColor">
            <input type="file" hidden ref="imageInput" accept="image/png, image/gif, image/jpg, image/jpeg"
                @change="handleImageChange">
        </div>
        <div class="flex p-2 pl-14">
            <!-- Icons -->
            <div class="flex w-full text-white">
                <div class="p-2 text-blue-400 rounded-full hover:bg-blue-50 hover:cursor-pointer dark:hover:bg-dim-800"
            ...
            <div class="ml-auto">
                <UiButton size="md" :disabled="isDisabled" @onClick="handleFormSubmit">
